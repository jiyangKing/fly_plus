...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	@Transactional(readOnly = false)
	public void updateSecurityCodeById(String id, String loginName) {
		User user = new User(id);

//		user.setSecurityCode();
		userDao.updateSecurityCodeById(user);
		// 清除用户缓存
		user.setLoginName(loginName);
		UserUtils.clearCache(user);
//		// 清除权限缓存
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n    Powered By "+Global.getConfig("poweredBy")+"\r\n");
		sb.append("\r\n    Website "+Global.getConfig("poweredByWebsite")+"\r\n");
		sb.append("\r\n======================================================================\r\n");
