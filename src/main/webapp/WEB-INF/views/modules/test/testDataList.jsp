...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/test/testData/">测试功能列表</a></li>
		<shiro:hasPermission name="test:testData:edit"><li><a href="${ctx}/test/testData/form">测试功能添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="testData">
			<tr>
				...
				<shiro:hasPermission name="test:testData:edit"><td>
					...
					<a href="${ctx}/test/testData/delete?id=${testData.id}" onclick="return confirmx('确认要删除该测试功能吗？', this.href)">删除</a>
